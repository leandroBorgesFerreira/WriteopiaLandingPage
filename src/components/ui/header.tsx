...
export default function Header() {
  ...
  const secondItems = [
    { label: 'Download App - Mac', href: 'https://github.com/leandroBorgesFerreira/Writeopia/releases/download/app-macos-alpha21/Writeopia-alpha21.dmg' },
    { label: 'Download App - Mac (Intel)', href: 'https://github.com/leandroBorgesFerreira/Writeopia/releases/download/app-macos-alpha21/Writeopia-alpha21-intel.dmg' },
