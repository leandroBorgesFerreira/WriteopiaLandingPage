...
export default function Header() {
  ...
  const secondItems = [
    { label: 'Download App - Mac', href: 'https://github.com/leandroBorgesFerreira/Writeopia/releases/download/app-macos-alpha20/Writeopia-alpha20.dmg' },
    { label: 'Download App - Mac (Intel)', href: 'https://github.com/leandroBorgesFerreira/Writeopia/releases/download/app-macos-alpha20/Writeopia-alpha20-intel.dmg' },
