...
export default function Header() {
  ...
  const secondItems = [
    { label: 'Download App - Mac', href: 'https://github.com/leandroBorgesFerreira/Writeopia/releases/download/app-macos-alpha22/Writeopia-alpha22.dmg' },
    { label: 'Download App - Mac (Intel)', href: 'https://github.com/leandroBorgesFerreira/Writeopia/releases/download/app-macos-alpha22/Writeopia-alpha22-intel.dmg' },
