...
export default function Header() {
  ...
  const secondItems = [
    { label: 'Download - MacOS', href: 'https://github.com/leandroBorgesFerreira/Writeopia/releases/download/app-macos-alpha28/Writeopia.dmg' },
    { label: 'Download - MacOS (Intel)', href: 'https://github.com/leandroBorgesFerreira/Writeopia/releases/download/app-macos-alpha28/Writeopia-intel.dmg' },
    { label: 'Download - Linux (.deb)', href: 'https://github.com/leandroBorgesFerreira/Writeopia/releases/download/app-macos-alpha28/Writeopia.deb' },
