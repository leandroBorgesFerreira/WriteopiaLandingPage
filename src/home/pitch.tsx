    ...
    <Suspense fallback="loading">
      <div className="flex flex-col-reverse lg:flex-row items-center py-10">   
        <div className="p-6 px-10 items-center justify-center dark:text-gray-200 text-left max-w-4xl">
          <h2 className="text-6xl font-bold">{t('pitch_data_choice_title')}</h2>
  ...
  return (
    <Suspense fallback="loading">
      <div className="flex flex-col lg:flex-row items-center py-10">        
        ...
        <div className="p-6 px-10 items-center justify-center dark:text-gray-200 text-left max-w-4xl">
          <h2 className="text-6xl font-bold">{t('pitch_ai_choice_title')}</h2>
...
function OpenFormat() {
  ...
  return (
    <Suspense fallback="loading">
      <div className="flex flex-col-reverse lg:flex-row items-center py-10">   
        <div className="p-6 px-10 items-center justify-center dark:text-gray-200 text-left max-w-4xl">
          <h2 className="text-6xl font-bold">{t('pitch_no_lockin_title')}</h2>
  ...
  return (
    <Suspense fallback="loading">
      <div className="flex flex-col lg:flex-row items-center pt-10">
        ...
        <div className="p-6 px-10 items-center justify-center dark:text-gray-200 text-left max-w-4xl">
          <h2 className="text-6xl font-bold">{t('pitch_pretty_design_title')}</h2>
